 ...
 */
public class Bus {
    private String bus_id,company_id,seat_id,travel_route_id,bus_plate_number,seat_design;

    public Bus() {
    }

    public Bus(String bus_id, String company_id, String seat_id, String travel_route_id, String bus_plate_number, String seat_design) {
        this.bus_id = bus_id;
    ...
    public String toString() {
        return "Bus{" + "bus_id=" + bus_id + ", company_id=" + company_id + ", seat_id=" + seat_id + ", travel_route_id=" + travel_route_id + ", bus_plate_number=" + bus_plate_number + ",seat_design=" + seat_design+'}';
    }
}
